...
'draw string 0.1 8.3 `nPrecip. Accumulation (MAX All Members) | College of DuPage NeXLaB'
*give the product a name between sector and fhour variables and combo into filename variables
prodname = modname sector _prec_maxprec_ fhour
...
'set gxout shade2'
if fhour = 006
 'define paccum = max(APCPsfc/25.4, e=1, e=20)'
else
 'define paccum = sum(max(APCPsfc/25.4, e=1, e=20),t=1,t='fhour/6+1',1)'
endif
'd paccum'
