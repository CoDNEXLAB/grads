...
'draw string 0.1 8.3 250mb Isotachs (kts) | Geopotential Height (gpm) | College of DuPage NeXLaB'
*give the product a name between sector and fhour variables and combo into filename variables
prodname = modname sector _250_spd_ fhour
filename = basedir'/'modname'/'modinit'/'sector'/'prodname%filext
*pick a colorbar
'run /home/scripts/grads/colorbars/color.gs 50 230 5 -kind white-(0)->darkgreen-(4)->lime-(0)->olive-(4)->yellow-(0)->maroon-(4)->red-(0)->darkmagenta-(4)->magenta-(0)->mediumblue-(4)->cyan-(0)->gray-(4)->white'
*set level (set both!)
level = 250
'set lev 'level
