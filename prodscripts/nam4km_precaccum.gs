...
if fhour = 002 | fhour = 004 | fhour = 006 | fhour = 008 | fhour = 010 | fhour = 012 | fhour = 014 | fhour = 016 | fhour = 018 | fhour = 020 | fhour = 022 | fhour = 024 | fhour = 026 | fhour = 028 | fhour = 030 | fhour = 032 | fhour = 034 | fhour = 036 
 'define paccum = sum((APCPsfc/25.4),t=1,t='fhour+1',2)'
endif
if fhour = 003 | fhour = 005 | fhour = 007 | fhour = 009 | fhour = 011 | fhour = 013 | fhour = 015 | fhour = 017 | fhour = 019 | fhour = 021 | fhour = 023 | fhour = 025 | fhour = 027 | fhour = 029 | fhour = 031 | fhour = 033 | fhour = 035
 'define paccum1 = sum((APCPsfc/25.4),t=1,t='fhour/3',2)'
 'define paccum2 = APCPsfc/25.4'
 'define paccum = paccum1+paccum2'
endif
if fhour = 039 | fhour = 042 | fhour = 045 | fhour = 048 | fhour = 051 | fhour = 054 | fhour = 057 | fhour = 060
 'define paccum1 = sum((APCPsfc/25.4),t=1,t='37',2)'
 'define paccum2 = sum((APCPsfc/25.4),t='37',t='fhour+1',1)'
 'define paccum = paccum1+paccum2'
endif
'd paccum'
