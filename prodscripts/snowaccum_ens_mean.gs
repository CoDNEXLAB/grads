...
prodname = modname sector _prec_meansnowaccum_ fhour
...
if fhour = 006
 'define snaccum = ave(APCPsfc/2.54*CSNOWsfc, e=1, e=20)'
else
 'define snaccum = sum(ave(APCPsfc/2.54*CSNOWsfc, e=1, e=20),t=1,t='fhour/6+1',1)'
endif
'd snaccum'
