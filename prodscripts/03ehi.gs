...
'draw string 0.1 8.3 0-3km Energy Helicity Index | College of DuPage NeXLaB'
*give the product a name between sector and fhour variables and combo into filename variables
prodname = modname sector _con_3kmehi_ fhour
filename = basedir'/'modname'/'modinit'/'sector'/'prodname%filext
*pick a colorbar
'run /home/scripts/grads/colorbars/color.gs 0 15 .25 -kind white-(0)->white-(0)->lightgray-(3)->limegreen-(3)->yellow->goldenrod->red->maroon->magenta->darkmagenta->powderblue->deepskyblue'
'set gxout shade2'
'define ehi03 = HLCY3000_0m*CAPEsfc/160000'
'd ehi03'
