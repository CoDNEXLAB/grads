...
'draw string 0.1 8.3 `nSupercell Composite Parameter (MAX All Members) | College of DuPage NeXLaB'
*give the product a name between sector and fhour variables and combo into filename variables
prodname = modname sector _con_maxscp_ fhour
...
'define maxscp = max(scp1, e=1, e=20)'
'set e 1'
'd smth9(maxscp)'
...
'run /home/scripts/grads/functions/pltcolorbar.gs -ft 1 -fy 0.33 -line on -fskip 1 -fh .1 -fw .1 -lc 0 -edge triangle -fc 99'
