...
'run /home/scripts/grads/colorbars/color.gs -5 15 .5 -kind darkseagreen->lightgray->lightsteelblue->magenta->mediumblue->cyan->green->yellow->orange->red->maroon->magenta->white'
'set gxout shade2'
*START: PRODUCT SPECIFIC ACTIONS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*give the image a product title
'draw string 0.1 8.3 Lid Strength Index | College of DuPage NEXLAB'
'set lev 500'
't = TMPprs'
'tc=(t-273.16)'
'rh = RHprs'
...
'define thteup=theta*exp((3.376/Tlcl-0.00254)*mixr*1.0+0.00081*mixr)'
'set lev 1000'
't = TMPprs'
'tc=(t-273.16)'
'rh = RHprs'
...
'undefine e'
'define theta=t*pow(1000/lev,0.286)'
'define thtlow=theta*exp((3.376/Tlcl-0.00254)*mixr*1.0+0.00081*mixr)'
'define lsi=thteup-thtlow'
'd lsi'
