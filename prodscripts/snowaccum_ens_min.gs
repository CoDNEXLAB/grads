...
'draw string 0.1 8.3 `nSnowfall 10:1 Ratio (MIN All Members) | College of DuPage NeXLaB'
*give the product a name between sector and fhour variables and combo into filename variables
prodname = modname sector _prec_minsnacc_ fhour
...
if fhour = 006
 'define snaccum = min(APCPsfc/2.54*CSNOWsfc, e=1, e=20)'
else
 'define snaccum = sum(min(APCPsfc/2.54*CSNOWsfc, e=1, e=20),t=1,t='fhour/6+1',1)'
endif
'd snaccum'
