...
if (($FHour == 000) || ($FHour == 003)) then
	...
	perl /home/scripts/grads/functions/gfs_mpi_g2ctl.pl -nthreads 32 ${ctlFile} > /home/scripts/grads/grads_ctl/${ModName}/${ModInit}${ModName}.ctl	
endif
...
foreach Sector (US MW SGP CGP NGP SW NW SE MA NE FLT AK WCAN PO AO NA WLD)
	...
	grads -bxcl "run /home/scripts/grads/runners/gfs_prodlist.gs ${ModInit} ${ModName} ${FHour} ${Sector} ${ModRunTime}" &
end
wait
