...
if (($FHour == 000) || ($FHour == 001)) then
	...
	perl /home/scripts/grads/functions/rap_g2ctl.pl ${ctlFile} > /home/scripts/grads/grads_ctl/${ModName}/${ModInit}${ModName}.ctl
endif
...
foreach Sector (MW US SGP CGP NGP SW NW SE MA NE FLT)
	...
	grads -bxcl "run /home/scripts/grads/runners/rap_grads_prodlist.gs ${ModInit} ${ModName} ${FHour} ${Sector} ${ModRunTime}" &
end
wait
